...
#              All files in folder SCRIPTS_ROOT will be executet. Currently just
#              *.sh, *.ldif and *.conf files are supported.
...
#              with a number. For example 01_instance.conf, 02_schemaextention.ldif, etc.
# Reference..: --
